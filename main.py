...
while True:
    ...
    if choice == "1":
        ...
        if faculty_choice == "1":
            ...
            # implementarea operatiei de absolvire a unui student dintr-o facultate
            pass

        elif faculty_choice == "3":
            # implementarea afișării studenților înscriși în prezent
            pass

        elif faculty_choice == "4":
            # implementarea afișării absolvenților
            pass

        elif faculty_choice == "5":
            # implementarea verificării dacă un student aparține unei facultăți
            pass
